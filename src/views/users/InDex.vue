...
<style>
/* 样式重置 */
body, html, div, a, nav, header, main, footer {
  margin: 0;
  padding: 0;
...
<!--              <img src="./1.png" style="width: 100%;height: 100%" alt="">-->
...
<!--&lt;!&ndash;    静态资源路径在public下，可以 src=“image-1703137658450-541258706.png” 拿到那张图片&ndash;&gt;-->


<!--&lt;!&ndash;    <div class="upload_file">&ndash;&gt;-->
<!--&lt;!&ndash;      <input type='file' ref="fileInput" @change="uploadFile">&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->


<!--&lt;!&ndash;    <div class="showImg">&ndash;&gt;-->
